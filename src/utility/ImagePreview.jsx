...
const ImagePreview = ({type,values}) => {
    return (
        <>
        <div className='dropzone mb-3'><div className='dz-preview mb-3 dz-processing dz-image-preview dz-success dz-complete'> <div className="d-flex flex-row "> <div className="p-0 w-30 position-relative" >
